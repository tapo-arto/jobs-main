 ...
 */
function tjobs_output_schema_markup() {
    if ( ! is_singular( 'tjobs_tyopaikat' ) ) {
        return;
    }
    ...
    $original_link   = get_post_meta( $post_id, '_tjobs_rss_link', true );
...
add_action( 'wp_head', 'tjobs_output_schema_markup' );
