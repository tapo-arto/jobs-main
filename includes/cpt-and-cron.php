...
// === 1. CPT-rekisteröinti ===
if ( ! function_exists( 'map_register_cpt_jobs' ) ) {
...
if ( ! function_exists( 'map_add_cron_intervals' ) ) {
...
// Cronin aktivointi
if ( ! function_exists( 'map_activate_cron' ) ) {
...
// Cronin deaktivointi
if ( ! function_exists( 'map_deactivate_cron' ) ) {
...
if ( ! function_exists( 'map_update_cron_schedule' ) ) {
